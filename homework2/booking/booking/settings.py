...
SECRET_KEY = 'django-insecure-xgo#s5l^fvarozf)oxr)7+y^fq^igr7gx2^7u+2-up@7jzkj!0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['cs4300-ch03.onrender.com', 'localhost', '127.0.0.1']
...
MIDDLEWARE = [
    ...
    'booking.middleware.TestUserMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'booking', 'templates', 'booking')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
